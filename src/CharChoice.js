...
import {StyleSheet, Text, View, Image, TextInput, TouchableOpacity, KeyboardAvoidingView, TouchableWithoutFeedback, Keyboard, ScrollView} from 'react-native';
    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <View style={styles.inputView}>
            ...
            {this.state.disabled == true ?   <CharButtonN title= {this.state.text}/> : null}
            ...
            title="추가"
            raised="true"
            buttonStyle={styles.AB}
            onPress={()=>this.state.text.length==0 ? this.setState({disabled:false}) :  this.setState({disabled:true})}
            />
